...
const p = (id: string, name: string, price: number, category: string, description: string, rating = 4.8, premium = false, subcategory?: string): Product =>
  ({ id, name, price, category, subcategory, description, rating, premium });

export const products: Product[] = [
  p("inc-cascata-01", "Incensário Cascata Onírico", 189, "incensos", "Cerâmica fosca artesanal para incensos cascata. A fumaça desce em véu sobre montanhas esculpidas.", 4.9, true, "Cascata"),
  p("filtro-01", "Filtro dos Sonhos Lua Cheia", 149, "decoracao-mistica", "Anel dourado, penas naturais e cristal central. Suspenso, parece flutuar.", 4.8, false, "Adornos"),
  ...
  p("arvore-01", "Árvore de Pedras Quartzo Rosa", 269, "cristais-e-pedras", "Galhos de cobre revestido, base em quartzo bruto, copa em pedras roladas.", 4.8, true, "Árvores"),
  ...
  p("indio-01", "Xamã Índio Esculpido", 289, "imagens-religiosas", "Cocar em camadas, pintado à mão.", 4.8, true, "Índios"),
  ...
  p("mur-01", "Murano Coleção Aurora", 179, "cristais-e-pedras", "Vidro italiano com infusão de ouro. Peça única.", 4.8, false, "Muranos"),
  p("vela-rit-01", "Vela Ritualística Trindade Dourada", 99, "velas", "Cera de soja perfumada com olíbano, mirra e benjoim.", 4.9, true, "Ritualísticas"),
  p("lotus-01", "Porta-velas Flor de Lótus", 109, "velas", "Pétalas em metal recortado, brilho ambarino na chama.", 4.8, false, "Decorativas"),
  p("dragao-01", "Incensário Dragão Oriental", 169, "incensos", "Liga metálica patinada, fumaça pela boca.", 4.8, false, "Cones"),
  p("ele-01", "Incensário Elefante Sagrado", 159, "incensos", "Inspiração indiana, base perfurada.", 4.8, false, "Varetas"),
  p("coruja-01", "Incensário Coruja Guardiã", 149, "incensos", "Olhos em pedra natural.", 4.8, false, "Porta-incensos"),
  p("cig-01", "Baralho Cigano Premium", 139, "baralhos", "78 cartas com acabamento dourado nas bordas.", 4.8, false, "Cigano"),
  ...
  p("esc-01", "Escapulário Veludo & Prata", 89, "catolicos", "Cordão em veludo italiano, medalhas em prata 925.", 4.8, false, "Escapulários"),
  p("ter-01", "Terço Ágata Negra", 139, "catolicos", "Contas naturais, cruz em prata patinada.", 4.8, false, "Terços"),
  p("med-01", "Medalha São Bento Ouro Velho", 79, "catolicos", "Banho de ouro 18k sobre prata.", 4.8, false, "Medalhas"),
  p("cru-01", "Crucifixo de Parede Madeira & Latão", 229, "catolicos", "Linhas contemporâneas, 60cm.", 4.8, false, "Crucifixos"),
  p("esc-esp-01", "Escultura Espiritual Mãos em Prece", 339, "decoracao-mistica", "Cimento queimado fosco.", 4.8, true, "Adornos"),
];
